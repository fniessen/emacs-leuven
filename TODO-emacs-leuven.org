...
- Demander à Cgpt quels sont les rapports courants sous Todoist, Monday.com, Trello
  et Jira, par exemple
- Preset "-MAYB" de manière auto ; voir impact
- Assignee tag (@nnn) permet de grepper dans tous les fichiers et de voir tout
...
*** TODO Enhance org-switch-language: disable flyspell-mode if dico is not found

Error in post-command-hook: (error Error: The file "/usr/lib/aspell/fr_FR" can
not be opened for reading.)

*** TODO Spell check comments and strings in source code blocks

#+begin_src emacs-lisp
;; Does it really work?
(setq abc "This is a string in English.")

;; Cela marche-t-il ?
(setq def "Ceci est une chaîne de caractères en français.")
#+end_src
